package org.apache.iotdb.utils.core.parse;
                ...
                if (headerNameFull.equals("Time")) {
                    ...
                    if (TEXT.equals(type)) {
                        if(!"".equals(record.get(headerNameFull))){
                            if(!record.get(headerNameFull).startsWith("\"") || !record.get(headerNameFull).endsWith("\"")){
                                bf2.append(",")
                                        .append(headerName.substring(headerName.lastIndexOf(".") + 1, headerName.length()));
                                bf3.append(",\"")
                                        .append(record.get(headerNameFull))
                                        .append("\"");
                            }else{
                                bf2.append(",")
                                        .append(headerName.substring(headerName.lastIndexOf(".") + 1, headerName.length()));
                        ...
                        if(record.get(headerNameFull).equals("true") || record.get(headerNameFull).equals("false")){
                            bf2.append(",")
                                    .append(headerName.substring(headerName.lastIndexOf(".") + 1, headerName.length()));
                            bf3.append(",")
                                    .append(record.get(headerNameFull));
        ...
        for (String headerName : headerNames) {
            ...
            if (matcher.find()) {
                ...
                String headerNameWithoutType =
                        headerName.replace(new StringBuilder("(").append(type).append(")").toString(), "").replaceAll("\\s+", "");
