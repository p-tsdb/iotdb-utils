...
public class ExportTool13_1 extends AbstractCsvTool {
    ...
    private static void parseSpecialParams(CommandLine commandLine) throws ArgsErrorException, ParamCheckException {
        ...
        String needTimeseriesStructureAlgorithm = commandLine.getOptionValue(NEED_TIMESERIES_STRUCTURE_ARGS);
    ...
    private static Options createOptions() {
        ...
        Option opFileStrategy =
                Option.builder(FILE_SINK_STRATEGY_ARGS)
                        ...
                        .hasArg()
                        .desc("two strategy: 1.entity path as file name 2.a extra catalog file records the entity path and file (optional)")
                        .build();
